...
const projectData = {
  ...
  cgi: {
    ...
    role: "Senior Business Analyst",
    description:
      "Co‑led a global, multidisciplinary DevOps team responsible for enterprise IT Asset Management and technology governance across millions of assets in multiple jurisdictions. Leveraged Flexera and Business Adapter Studio to establish enterprise‑wide asset visibility, normalize asset data, integrate multiple inventory sources, and support automated provisioning and deprovisioning workflows through REST API‑driven enterprise automation. Maintained software licensing, compliance, security posture, and environment governance across the estate. Agile. Served as Scrum Master and coordinated Agile delivery across infrastructure, security, platform, and operational teams, while reporting to the CIO's Governance Board. Translated enterprise governance requirements into operational controls and technology solutions. Managed complex software and infrastructure lifecycles across multiple virtualized and containerized environments (Dev/QA/Prod). Supported Microsoft and Oracle license management by monitoring utilization across environments, performing data analysis, and utilizing Flexera Inventory Manager to identify IT Asset sprawl. Security operations. Used Flexera Beacon servers to perform automated inventory discovery and identify devices that had drifted from required country-specific security baselines, including those missing encryption or exposing real machine identifiers. Used a custom encryption tool to re‑encrypt and restore impacted devices to compliance. DevOps. Leveraged APIs and enterprise automation to provision and deprovision devices, servers, and virtual machines at scale, integrating with Kubernetes clusters, Nutanix AHV, VMware ESXi, data‑masking platforms, and other enterprise infrastructure systems.",
